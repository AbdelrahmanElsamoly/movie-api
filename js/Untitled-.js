...
var row = document.getElementById("rowData"),
  ...
  searchURL =
    "https://api.themoviedb.org/3/search/movie?query=mad&api_key=eba8b9a7199efdcb0ca1f96879b83c44&language=en-US&include_adult=true",
  trendingURL =
...
search_bar.onkeyup = function () {
  ...
  for (var t = 0; t < allMovies.length; t++)
    1 == allMovies[t].original_title.includes(e) &&
      ((a +=
        '</h3><div class="col-md-4 my-3 shadow">\n            <div class="movie shadow rounded position-relative">\n                    <div class="post">\n                    <img src=' +
        imgPath +
        allMovies[t].poster_path +
        ' class="img-fluid rounded"/>\n                    <div class="layer d-flex align-items-center ">\n                    <div class="info p-5">\n                   \n                        <h2>' +
        allMovies[t].original_title +
        "</h2>\n                        <p>" +
        allMovies[t].overview +
        "</p>\n                        <p >rate: " +
        allMovies[t].vote_average +
        "</p>\n                        <p>" +
        allMovies[t].release_date +
        "</p>\n                        \n                    </div>\n                    </div>\n                    </div>\n                    </div>\n                </div>"),
      (result.innerHTML = a));
};
...
function userAgeValid() {
  return 1 == /^[1-9][0-9]?$|^100$/.test(userAge.value)
    ...
    : ((userAgeAlert.style.display = "block"), console.log("dkldkdlkdlk"), !1);
}
